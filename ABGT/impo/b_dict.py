...
ru_main = InlineKeyboardMarkup(inline_keyboard=[
    ...
    [InlineKeyboardButton(text='⚖ История покупок',callback_data='pur_h'),
...
en_main = InlineKeyboardMarkup(inline_keyboard=[
    ...
    [InlineKeyboardButton(text='⚖ Your purchase history',callback_data='pur_h'),
...
uk_main = InlineKeyboardMarkup(inline_keyboard=[
    ...
    [InlineKeyboardButton(text='⚖ Історія ваших придбань',callback_data='pur_h'),
